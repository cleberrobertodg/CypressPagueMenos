describe('Teste PagMenos', function() {
    ...
    beforeEach(() => {
            ...
            cy.get('#novo_cpf').type('40957788819', {force:true})
    ...
    it('Cadastro de Cupom PagMenos', function() {
        ...
        cy.get('#cupo_codigo').type('50', {force:true})
    ...
    it('Validar bloqueador de duplicar cadastro de cupom', function(){
        ...
        cy.get('body > div.enc--wrapper > div.page--cadastro-cupom.page-internas > div > form > div > div:nth-child(6) > div > button').click({force:true})
        cy.wait(500)
        cy.get('#modalMsg > div > div > div:nth-child(2) > div > p').should('be.visible').contains('Cupom já cadastrado.')
